...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin/css/plugins/simple-line-icons.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin/css/plugins/animate.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{URL::asset('admin/css/plugins/fullcalendar.min.css')}}" />
...
<body id="mimin" class="dashboard">
            ...
            <div class="navbar-header" style="width:100%;">
                ...
                <ul class="nav navbar-nav navbar-right user-nav">
                    ...
                    <li class="dropdown avatar-dropdown">
                        <img src="{{asset('admin/img/avatar.jpg')}}" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" />
    ...
    <div class="container-fluid mimin-wrapper">
        <!-- start:Left Menu -->
        <div id="left-menu" style='margin-top: -200px'>
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-table"></span> Tables  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                        <ul class="nav nav-list tree">
                            <li><a href="{{route('database')}}">Data Khách hàng</a></li>
                            <li><a href="{{route('datanhanvien')}}">Data Nhân viên</a></li>
                            <li><a href="{{route('dataphong')}}">Data Phòng</a></li>
                        </ul>
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-check-square-o"></span> Forms  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                        <ul class="nav nav-list tree">
                            <li><a href="{{route('form')}}">Form Phòng</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <script src="{{URL::asset('admin/js/plugins/fullcalendar.min.js')}}"></script>
    <script src="{{URL::asset('admin/js/plugins/jquery.nicescroll.js')}}"></script>
    <script src="{{URL::asset('admin/js/plugins/jquery.vmap.min.js')}}"></script>
    <script src="{{URL::asset('admin/js/plugins/maps/jquery.vmap.world.js')}}"></script>
    <script src="{{URL::asset('admin/js/plugins/jquery.vmap.sampledata.js')}}"></script>
    <script src="{{URL::asset('admin/js/plugins/chart.min.js')}}"></script>
    <!-- custom -->
