    ...
    <div class="panel">
        <div class="panel-body">
            <div class="col-md-6 col-sm-12">
                <h3 class="animated fadeInLeft">Restaurant Angela</h3>
                <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span> Nha Trang,Việt Nam</p>
            </div>
            <div class="col-md-6 col-sm-12">
                <div class="col-md-6 col-sm-6 text-right" style="padding-left:10px;">
                    <h3 style="color:#DDDDDE;"><span class="fa  fa-map-marker"></span> Nha Trang</h3>
                    <h1 style="margin-top: -10px;color: #ddd;">27<sup>o</sup></h1>
                </div>
                        ...
                        <div class="panel box-v1">
                            <div class="panel-heading bg-white border-none">
                                <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                    <h4 class="text-left">Khách hàng</h4>
                                </div>
                ...
                <div class="col-md-12 padding-0">
                    <div class="panel box-v2">
                        <div class="panel-heading padding-0">
                            <img src="{{asset('admin/img/bg2.jpg')}}" class="box-v2-cover img-responsive" />
                            <div class="box-v2-detail">
                                <img src="{{asset('admin/img/avatar.jpg')}}" class="img-responsive" />
                                <h4>ADMIN</h4>
                            </div>
                        </div>
                        <div class="panel-body">
